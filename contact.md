...
<div class="row">
    ...
    <!--   <img src="{{ site.baseurl }}/Milan_horizontal.jpg" alt="Luisa Carrer" class="img-fluid" style="max-width: 100%;"> -->
        <img src="{{ site.baseurl }}/Turin_mole_quadrata.jpeg" alt="Luisa Carrer" class="img-fluid" style="max-width: 100%;">
    </div>
    ...
    <div style="font-size:15px;font-family: 'Source Sans Pro', sans-serif; color: #081b88"> <strong>E-mail:</strong> <a style="color: #081b88" href= "mailto:lcarrer@escp.eu"><u>lcarrer@escp.eu</u> &#9993;</a> </div>
